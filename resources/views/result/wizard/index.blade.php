  ...
  <div class="tab">
    ...
    <div class="row">
        <div class="col-sm-6">
                ...
                <input placeholder="Full Name" name="full_name" id="full_name" class="required">
        </div>
        <div class="col-sm-6">
            <?php 
            ...
            ?>
                ...
                <input placeholder="Job Position" name="job_position" id="job_position" class="required" value="{{ $dpos->position }}" disabled>
                <br><br>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
                ...
                <input placeholder="Date of Birth" name="date_birth" id="date_birth" class="required tanggal" autocomplete="off">
                <br><br>
        </div>
        <div class="col-sm-6">
