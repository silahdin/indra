...
<div style="float:right;">
  ...
  <div class="tab">
    ...
    <div class="row">
        <div class="col-sm-12">
                <label for="sel1">Latest compensation</label>
                <input placeholder="Latest compensation" name="latest_compensation" id="latest_compensation" class="required number">
        </div>
    </div>

    <hr>
    <h5><i class="fa fa-asterisk" aria-hidden="true" style="font-size: 12px !important; color:blue"></i> Work Experience</h5>
    <table border="1px" width="100%">
      <tr>
        ...
        <td align="center">Job Responsibilities</td>
        <td align="center">Achievements</td>
        <td align="center">Reasons for Leaving</td>
      </tr>
      ...
      <tr align="center" class="tr_clone">
        ...
        <td><input type="text" name="from[]" id="from" value="" class="input numbersOnly tahun"  style="width:50px !important" placeholder="From" maxlength="4" autocomplete="off" >
          <input type="text" name="to[]" id="to" value="" class="input numbersOnly tahun" style="width:50px !important" placeholder="To" maxlength="4" autocomplete="off" ></td>
    ...
    <h5><i class="fa fa-asterisk" aria-hidden="true" style="font-size: 12px !important; color:blue"></i> Professional References <small>(provide at least 2 names)</small></h5>
    <table border="0px" width="100%">
      <tr>
        <td style="width: 500px"><strong>1.</strong> Name</td>
        <td>:</td>
        <td><input type="text" name="name[]" id="name" value="" class="input" required ></td>
      </tr>
      <tr>
          <td>Relationship</td>
          <td>:</td>
          <td><input type="text" name="relationship[]" id="relationship" value="" class="input" required></td>
      </tr>
      <tr>
        <td>Cellular & Email</td>
        <td>:</td>
        <td><input type="text" name="contact[]" id="contact" value="" class="input" required></td>
      </tr>

      <tr>
          <td style="width: 500px"><strong>2.</strong> Name</td>
          <td>:</td>
          <td><input type="text" name="name[]" id="name" value="" class="input" required ></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 500px"><strong>3.</strong> Name</td>
            <td>:</td>
