          ...
          $.ajax({
              ...
              success: function (data) { 
                if(data.status == "success") {
                  window.location.href = '{{route('english.step4')}}';
                } else {
...
<div style="float:right;">
  ...
  @csrf
  <input type="hidden" name="step" value="4e">
  ...
  <div style="overflow:auto;">
    <div style="float:right;">
        <button type="button" id="prevBtn" onclick="location.href='{{route('english.step1')}}'">Previous</button>
