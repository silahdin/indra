...
<div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('pubAn.store') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                  ...
                  <script>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('title_in') ? ' is-invalid' : '' }}" name="title_in" id="title_in" placeholder="Text Chinese" value="{{ old('title_in') }}" required>
