...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit Bertia/Artikel</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">@lang('main.edit_news')
      ...
      $(function() {
        ...
        $('form').submit(function() {
          ...
          return true;
                    ...
                    <div class="form-group">
                        <label for="categories_id">@lang('main.kategori')</label>
                        <select class="form-control{{ $errors->has('categories_id') ? ' is-invalid' : '' }}" name="categories_id" id="categories_id" style="width: 100%;" required>
                            ...
                            <?php foreach ($cat as $key) { ?>
                                <option value="{{ $key->id }}" @if($key->id==$post->categories_id) selected @endif> {{ $key->name_in }} </option>
                            <?php } ?>
                        </select>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="location.href='{{ route('article') }}'">@lang('main.cancel')</button>
                  </div>
                </form>
              </div>
          <!-- /.box -->
