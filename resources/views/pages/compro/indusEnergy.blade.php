...
@section('content')
<?php
$imgBanner = asset('assets/compro/assets/frontend_assets/images/banner/Energy.jpg');
?>
	<div class="space-top">
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-12">
							<p>@lang('main.indus_energy_title1')</p>
							<p>@lang('main.indus_energy_title2')</p>
							<p>@lang('main.indus_energy_title3')</p>
							<ul class="ul-pad-L-0">
