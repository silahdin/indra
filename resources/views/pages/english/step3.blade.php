...
<div style="float:right;">
  ...
  <div class="tab">
    ...
    <p><span style="font-size: 16px; font-weight: bold">Choose the appropriate options to complete the sentences</span></p>            
  ...
  <div style="overflow:auto;">
    <div style="float:right;">
            <button type="button" id="prevBtn" onclick="location.href='{{route('english.step2', ['idjob' => $jobid])}}'">Previous</button>
