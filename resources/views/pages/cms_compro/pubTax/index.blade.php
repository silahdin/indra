        ...
        <section class="content">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Data Pub. Tax </h3>
            ...
            <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td> <a href="{{ $post->doc }}">@lang('main.document_type')</a></td>
                        <td>@if($post->title_language==1)
                              <span  style="font-size: 14px">@lang('main.title_english')</span>
                            @elseif($post->title_language==2)
                              <span  style="font-size: 14px">@lang('main.title_chinese')</span>
                            @endif
                        </td> 
                        <td>
                        ...
                        <td>
                            <a href="{{ route('pubTax.edit', ['id' => $post->id]) }}">
                                <i class="fa fa-edit text-blue" style="font-size: 20px"></i>
                            </a>&nbsp;
                            <a href="{{ route('pubTax.delete', ['id' => $post->id]) }}" onclick="return confirm('Apakah anda yakin akan menghapus {{ $post->id }}?')">
