...
<div style="float:right;">
  ...
  <div class="tab">
    ...
    <p><span style="font-size: 16px; font-weight: bold">In each question you will see a text with 3 underlined words or phrases. One of these is incorrect or needs to be re-written. Select the incorrect option. 
    </span></p>            
