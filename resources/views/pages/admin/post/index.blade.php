            ...
            <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $post->title }}</td>
                        <td>{!! substr($post->short_desc,0,100) !!}</td>
                        <td>@if($post->st_post==1)  
                        ...
                        <td>
                            <a href="{{ route('page.edit', ['id' => $post->id]) }}">
                                <i class="fa fa-edit text-blue" style="font-size: 20px"></i>
                            </a>&nbsp;
                            <a href="{{ route('page.delete', ['id' => $post->id]) }}" onclick="return confirm('Apakah anda yakin akan menghapus {{ $post->title }}?')">
