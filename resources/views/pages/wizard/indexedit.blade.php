  ...
  <div class="tab">
    ...
    <div class="row">
        <div class="col-sm-6">
                ...
                <input placeholder="Full Name" name="full_name" id="full_name" class="required" value="{{ $dpribadi->full_name }}">
        </div>
        <div class="col-sm-6">
                <label for="sel1">Job Position</label>
                <input placeholder="Job Position" name="job_position" id="job_position" class="required" value="{{ $dpribadi->job_position }}" readonly>
                <br><br>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
                ...
                <input placeholder="Address" name="address" id="address" class="required" value="{{ $dpribadi->address }}">
                <br><br>
        </div>
        <div class="col-sm-6">
                <label for="sel1">Place of Birth</label>
                <input placeholder="Place of Birth" name="place_birth" id="place_birth" class="required" value="{{ $dpribadi->place_birth }}">
        </div>
        <div class="col-sm-6">
                <label for="sel1">Date of Birth</label>
                <input placeholder="Date of Birth" name="date_birth" id="date_birth" class="required tanggal" autocomplete="off" value="{{ $dpribadi->date_birth }}">
                <br><br>
        </div>
        <div class="col-sm-6">
                <label for="sel1">Date of Availability</label>
                <input placeholder="Date of Availability" name="date_availability" id="date_availability" class="required tanggal" autocomplete="off" value="{{ $dpribadi->date_availability }}">
                <br><br>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-4">
                ...
                <input placeholder="Home" name="contact_home" id="contact_home" class="required nomer" value="{{ $dpribadi->contact_home }}">
        </div>
        <div class="col-sm-4">
                <label for="sel1">Contact Information</label>
                <input placeholder="Cellular" name="contact_cellular" id="contact_cellular" class="required nomer" value="{{ $dpribadi->contact_cellular }}">
        </div>
        <div class="col-sm-4">
                <label for="sel1">Contact Information</label>
                <input placeholder="Email" name="contact_email" id="contact_email" class="required" type="email" value="{{ $dpribadi->contact_email }}">
                <br><br>
        </div>
    </div>
