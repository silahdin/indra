        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">@lang('main.edit_point') : {{ $post->title_in }}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('point_about.update', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="location.href='{{ route('point_about') }}'">@lang('main.cancel')</button>
                  </div>
                </form>
              </div>
          <!-- /.box -->
