...
class AdminLeadersController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $this->validate($request, [
            ...
            'summary_preview_ch' => 'required',
            'full_summary'    => 'required',
            'full_summary_ch'    => 'required',
            'edu_cert'        => 'required',
            'edu_cert_ch'        => 'required',
            'expertise_ch'       => 'required',
            'expertise'       => 'required',
            'industries_ch'      => 'required',
            'industries'      => 'required',
            'pro_societies'   => 'required',
            'pro_societies_ch'   => 'required',
        ]);
