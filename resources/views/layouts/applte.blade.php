...
<head>
  ...
  <!-- <link rel="stylesheet" href="{{ asset('assets/lte/dist/css/style_costum.css') }}"> -->
  <link rel="stylesheet" href="{{ asset('assets/lte/style_custom.css') }}">
  <!-- Google Font -->
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    Copyright © 2019 <strong>Reanda</strong>. All Rights Reserved.
  </footer>
