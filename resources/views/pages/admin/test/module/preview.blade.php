        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('module.index') }}" class="btn btn-primary" style="float: right; margin-right: 10px; padding-left: 20px; padding-right: 20px;">Back to Modules</a>
                </div>

                <div class="card-body">
                    <div style="padding: 10px; margin-bottom: 30px;">

                        <form id="add_form" action="{{ route('module.preview.post') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-footer" style="position: absolute; bottom: 20px; right: 30px;">
                                @if(@$first_step->id == @$last_step->id)
                                  ...
                                  <button style="padding-left: 20px; padding-right: 20px;" type="button" class="btn btn-success" name="navigation" value="last">Finish & Submit</button>
