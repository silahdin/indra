                ...
                <form action="{{ route('user.store') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" id="first_name" value="{{ old('first_name') }}" placeholder="First Name"required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" class="form-control{{ $errors->has('birthday') ? ' is-invalid' : '' }}" data-provide="datepicker" >
                            <input  maxlength="10" class="form-control " size="10" type="text" name="birthday" id="birthday" placeholder="Contoh, 11-08-2012" value="{{ old('birthday') }}" >
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender" id="gender" style="width: 100%;" required>
                            ...
                            <option value="male" {{ (old('gender') == 'male') ? 'selected' : '' }}>@lang('main.male')</option>
                            <option value="female" {{ (old('gender') == 'female') ? 'selected' : '' }}>@lang('main.female')</option>
                        </select>
                    ...
                    <div class="form-group">
                        <label for="email">@lang('main.karir_email') <span style="color:red;">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="password">@lang('main.password') <span style="color:red;">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="level">@lang('main.level') <span style="color:red;">*</span></label>
                        <select class="form-control{{ $errors->has('level') ? ' is-invalid' : '' }}" name="level" id="level" style="width: 100%;" required>
                            ...
                            <option value="user" {{ (old('level') == 'user') ? 'selected' : '' }}>Member</option>
                        </select>
                        @if ($errors->has('level'))
                            <span class="invalid-feedback" style="color: red">
                    ...
                    <div class="form-group">
                        <label for="st_user">@lang('main.status') <span style="color:red;">*</span></label>
                        <select class="form-control{{ $errors->has('st_user') ? ' is-invalid' : '' }}" name="st_user" id="st_user" style="width: 100%;" required>
                            ...
                            <option value="1" {{ (old('st_user') == 1) ? 'selected' : '' }}>@lang('main.activity')</option>
                            <option value="0" {{ (old('st_user') == 0) ? 'selected' : '' }}>@lang('main.non_activity')</option>
                        </select>
