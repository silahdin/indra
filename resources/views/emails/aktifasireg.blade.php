    ...
    <tr>
      <td valign="top">
        <a target='_blank' href="{{ url('/') }}">
          <img src="{{ env('APP_URL') }}assets/email/logo.jpeg" alt="Logo" title="Logo" height="60" data-max-width="100">
        </a>
      </td>
                          ...
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              ...
                              <p style="text-align: left;  color: black">
                                Welcome to Reanda Bernardi. To continue for your registration please enter your verification code, or <a href="{{ route('register.verify', ['email' => @$email, 'token' => @$token]) }}">go to verification page</a>.
                                <br>
                                <br>
                                <br>
                                <h2 style="color: #066360 !important;"><b>{{ @$token }}</b></h2>
                                <br>
                                <br>
                                HR<br>
                                Reanda Bernardi
