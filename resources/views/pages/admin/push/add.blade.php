...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Tambah Push Mobil</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah Push Mobil - @if($ps=="home") Home @else Pencarian @endif</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('push.store') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="to_date">To Date</label>
                          ...
                          <input type="text" name="to_date" class="form-control pull-right" id="to_date" value="{{ old('to_date') }}" autocomplete="off" required>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="user_id">Delaer</label>
                    ...
                    <div class="form-group">
                        <label for="possition">Posisi</label>
                          <select class="form-control{{ $errors->has('possition') ? ' is-invalid' : '' }} select2" name="possition" id="possition" style="width: 100%;" required>
                              @if($ps=="home")<option value="home" selected >Home</option>@endif
                              @if($ps=="pencarian")<option value="pencarian" selected>Pencarian</option>@endif
                          </select>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="location.href='{{ route('pushs') }}'">Cancel</button>
                  </div>
                </form>
              </div>
          <!-- /.box -->
