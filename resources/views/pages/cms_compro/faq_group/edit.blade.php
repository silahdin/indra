        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit FAQ Group</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('faq.group.update', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('group') ? ' is-invalid' : '' }}" name="group" id="group" placeholder="Group" value="{{ @$post->group }}" required>
                        @if ($errors->has('group'))
