                ...
                <form action="{{ route('faq.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control{{ $errors->has('question') ? ' is-invalid' : '' }}" name="question" id="question" placeholder="Kualifikasi English"  cols="5" rows="2" required>{{ old('question') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control{{ $errors->has('answer') ? ' is-invalid' : '' }}" name="answer" id="answer" placeholder="Kualifikasi English"  cols="5" rows="2" required>{{ old('answer') }}</textarea>
