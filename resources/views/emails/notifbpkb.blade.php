                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Hi Admin,</h2>
                              <br>
                              <p style="text-align: left">
                              Data detail mobil baru sebagai berikut:<br>
                              <strong>Nama :</strong> {{ $name }}<br>
                              <strong>Merk :</strong> {{ $merk }}<br>
                              <strong>Type :</strong> {{ $type }}<br>
                              <strong>Tahun :</strong> {{ $merk }}<br>
                              <strong>Warna :</strong> {{ $warna }}<br>
                              <strong>Transmisi :</strong> {{ $transmisi }}<br>
                              <strong>Kilometer :</strong> {{ number_format($kilometer) }}<br>
                              <strong>Pajak :</strong> {{ $pajak }}<br>
                              <strong>Harga :</strong> {{ number_format($price) }}<br>
                              <br>
                              Silahkan konfirmasi dengan klik link dibawah ini<br>
                              <a href="{{ url('/') }}/admin/dealers">konfirmasi</a>
                              <br><br>
                              Best regards,<br>
