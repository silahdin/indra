                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Hi {{ $userto }}</h2>
                              <br>
                              <p style="text-align: left">
                              Data detail bidding sebagai berikut:<br>
                              <strong>Judul:</strong> {{ $mobil }}<br>
                              <strong>Merk:</strong> {{ $merk }}<br>
                              <strong>Type:</strong> {{ $type }}<br>
                              <strong>Tahun:</strong> {{ $tahun }}<hr>
                              <strong>Dealer Bidding:</strong> {{ $userbid }}<br>
                              <strong>Harga Bidding:</strong> {{ $hargabid }}<br>
                              <br><br>
