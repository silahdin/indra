...
<div style="float:right;">
  ...
  <div class="tab">
    ...
    <p><span style="font-size: 16px; color: red"> <strong> Silakan Isi kotak-kotak di bawah ini dengan huruf S atau T</span><br><br>
            S: SAMA<br>
            T: TIDAK SAMA<br></strong>
    </p>
        <hr>
        <div class="row">
        <?php $no=1; ?>
        ...
        <div class="col-sm-6" style="height: 50px">
            <input type="text" name="jwb_{{$dsoal->id_words}}" class="input" maxlength="1" style="width: 35px" placeholder="S/T" value=""> <strong>{{$no}}.</strong> {!!$dsoal->question!!}
        </div>
        <?php $no++; ?>
        @endforeach
        </div>
