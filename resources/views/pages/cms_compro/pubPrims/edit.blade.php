...
?>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('pubPrims.update', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
        ...
        $('form').submit(function() {
          ...
          return true;
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="location.href='{{ route('pubPrims') }}'">@lang('main.cancel')</button>
                  </div>
                </form>
              </div>
          <!-- /.box -->
