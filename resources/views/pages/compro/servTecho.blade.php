...
<?php
$imgBanner = asset('assets/compro/assets/frontend_assets/images/banner/7. technology & operations service.jpg');
?>
	<div class="space-top">
	</div>
	...
	<section class="about flex-box"
		...
		<div class="boxes">
        <h1>@lang('main.servetecho_title')</h1>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="nav-services flex-box">
						...
						<a href="{{ route('compro.servTecho') }}" class="active">@lang('main.serveaccount_link6')</a>
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-12">
							<h5 class="h2-title">@lang('main.servetecho_detail')</h5>
							<p>@lang('main.servetecho_header')</p>
							<ul>
								<li>@lang('main.servetecho_list1')</li>
								<li>@lang('main.servetecho_list2')</li>
								<li>@lang('main.servetecho_list3')</li>
							</ul>
						</div>
					</div>
				</div>
