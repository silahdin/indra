                ...
                <form action="{{ route('step.store') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" value="{{ old('name') }}" placeholder="Step Name" required>
                        @if ($errors->has('name'))
                            <span class="invalid-feedback" style="color: red">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control{{ $errors->has('order') ? ' is-invalid' : '' }}" name="order" id="order" value="{{ old('order') }}" placeholder="Step Order" required>
                        @if ($errors->has('order'))
                            <span class="invalid-feedback" style="color: red">
