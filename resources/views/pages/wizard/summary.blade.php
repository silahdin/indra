...
<form id="regForm" action="{{route('wizard.post')}}" method="POST">
  ...
  <div class="tab">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
                <label for="sel1">Contact Information - Home</label>
                <br><span class="tebal">{{ $dpribadi->contact_home }}</span>
        </div>
        <div class="col-sm-4">
                <label for="sel1">Contact Information - Cellular</label>
                <br><span class="tebal">{{ $dpribadi->contact_cellular }}</span>
        </div>
        <div class="col-sm-4">
                <label for="sel1">Contact Information - Email</label>
                <br><span class="tebal">{{ $dpribadi->contact_email }}</span>
                <br><br>
        </div>
    </div>

    <h5><i class="fa fa-asterisk" aria-hidden="true" style="font-size: 12px !important; color:blue"></i> Family History</h5>
    ...
    @foreach($dreferences as $dreference)
      <tr>
        <td style="width: 500px"><strong>{{$no3}}.</strong> Name</td>
        <td>:</td>
      ...
      <tr>
        <td>Contact No. Ponsel/ Cellular & Email</td>
        <td>:</td>
    ...
    <h5><i class="fa fa-asterisk" aria-hidden="true" style="font-size: 12px !important; color:blue"></i> Language Ability <span id="jumlahq"></span></h5>
  ...
  <div style="overflow:auto;">
      <div style="float:right;">
          <button type="button" id="prevBtn" onclick="location.href='{{route('wizard_step3', ['idjob' => $jobid])}}'">Previous</button>
        <button type="button" id="nextBtn" onclick="location.href='{{route('lock', ['idjob' => $jobid])}}'">Lock Answer</button>
      </div>
    </div>
