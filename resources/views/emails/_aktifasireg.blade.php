...
<body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
  ...
  <tbody>
    <tr>
      <td valign="top"><img src="http://dev.reandabernardi.com/assets/compro/assets/frontend_assets/images/logo/ab.png" alt="Logo" title="Logo" height="60" data-max-width="100"></td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              <h2 style="font-size: 20px;">Dear {{ $name }}</h2>
                              <br>
                              <p style="text-align: left;  color: black">
                                Welcome to Reanda Bernardi. To continue your job application process please verify your email address by clicking the following 
                                <a href="{{route('home.aktifiasi', ['email' => $email, 'idjob' => $idjob])}}"><u><span style="color: blue">link.</span></u></a>
                                <br>
                                Thank you.
                                <br><br>
                                HR<br>
                                ...
                                <br>
                                <br>
                                You’re receiving this email because you recently registered for a job application process at Reanda Bernardi. If this wasn’t you, please ignore this email.
                                </p>
                            </div>
                          </div>
                        </td>
