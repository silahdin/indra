...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <li><a href="{{ route('dashboard') }}""><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{ route('pubAn')}}">Pub. Annual Review</a></li>
            <li class="active">Data Pub. Annual Review</li>
          </ol>
        </section>
...
?>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('pubAn.update', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
        ...
        $('form').submit(function() {
          ...
          return true;
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="location.href='{{ route('pubAn') }}'">@lang('main.cancel')</button>
                  </div>
                </form>
              </div>
          <!-- /.box -->
