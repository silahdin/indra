  ...
  <div class="tab">
    ...
    <div class="row">
        <div class="col-sm-12">
                ...
                <input placeholder="Kompensasi terakhir/Latest compensation" name="latest_compensation" id="latest_compensation" class="required number">
        </div>
    </div>
    ...
    <table border="0px" width="100%">
      <tr>
        <td style="width: 500px"><strong>1.</strong> Nama/ Name</td>
        <td>:</td>
      ...
      <tr>
          <td style="width: 500px"><strong>2.</strong> Nama/ Name</td>
          <td>:</td>
          <td><input type="text" name="name[]" id="name" value="" class="input" required ></td>
        </tr>
        <tr>
