        ...
        <section class="content">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Data Follows</h3>
            ...
            <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $post->textline }}</td>
                        <td><img src="{{ asset($post->icon) }}" alt="" width="90"></td>
                        <td>{{ $post->link }} </td>
                        <td>{{ ($post->link_open == 0) ? 'Same Page' : 'New Page' }}</td>
                        <td>
                            <a href="{{ route('follow.edit', ['id' => $post->id]) }}">
                                <i class="fa fa-edit text-blue" style="font-size: 20px"></i>
                            </a>&nbsp;
                            <a href="{{ route('follow.delete', ['id' => $post->id]) }}" onclick="return confirm('Apakah anda yakin akan menghapus data?')">
