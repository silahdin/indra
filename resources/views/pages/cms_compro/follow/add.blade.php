        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Follows</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('follow.store') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('textline') ? ' is-invalid' : '' }}" name="textline" id="textline" placeholder="Textline" value="{{ old('textline') }}" required>
        ...
        $('form').submit(function() {
          ...
          return true;
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link" id="link" placeholder="Link URL" value="{{ old('link') }}">
                        @if ($errors->has('link'))
                            <span class="invalid-feedback" style="color: red">
