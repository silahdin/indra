        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Our People</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('meet.people.update', ['id' => $post->id]) }}}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" placeholder="Name" value="{{ @$post->name }}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('position') ? ' is-invalid' : '' }}" name="position" id="position" placeholder="Position" value="{{ @$post->position }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control{{ $errors->has('words') ? ' is-invalid' : '' }}" name="words" id="words" placeholder="Words"  cols="5" rows="2" required>{!! @$post->words !!}</textarea>
                        @if ($errors->has('words'))
                            <span class="invalid-feedback" style="color: red">
