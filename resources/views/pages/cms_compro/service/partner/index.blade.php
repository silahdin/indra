            ...
            <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td><?php if($subs!=""){foreach ($subs as $sub) {
                          if ($sub->sub_services_id  == $partner->sub_service_id){ echo $sub->name;}
                        } } ?>
                        </td>
                        
                        <td><img src="{{ asset($partner->image) }}" alt="" width="50" height="50"></td>
                        <td>
                            <a href="{{ route('servicePartner.edit', ['id' => $partner->partner_id]) }}">
                                <i class="fa fa-edit text-blue" style="font-size: 20px"></i>
                            </a>&nbsp;
                            <a href="{{ route('servicePartner.delete', ['id' => $partner->partner_id]) }}" onclick="return confirm('Apakah anda yakin akan menghapus {{ $partner->name }}?')">
