                ...
                <form action="{{ route('user.store') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" placeholder="Nama User" value="{{ old('name') }}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group" id="cabang">
                            ...
                            <select class="form-control{{ $errors->has('cabang_id') ? ' is-invalid' : '' }} select2" name="cabang_id" id="cabang_id" style="width: 100%;">
                                ...
                                <option value="{{ $cabang->cabang_id }}">{{ $cabang->name_cabang }}</option>
                                @endforeach
                            </select>
