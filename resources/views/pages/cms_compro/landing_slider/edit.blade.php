        ...
        <section class="content">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Landing Page Slider</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('landing.slider.update', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('sub_title') ? ' is-invalid' : '' }}" name="sub_title" id="sub_title" placeholder="Sub Title" value="{{ @$post->sub_title }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control{{ $errors->has('brief') ? ' is-invalid' : '' }}" name="brief" id="brief" placeholder="Brief"  cols="5" rows="3">{!! @$post->brief !!}</textarea>
                        @if ($errors->has('brief'))
                            <span class="invalid-feedback" style="color: red">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('link_text') ? ' is-invalid' : '' }}" name="link_text" id="link_text" placeholder="Link Text" value="{{ @$post->link_text }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('link_url') ? ' is-invalid' : '' }}" name="link_url" id="link_url" placeholder="Link URL" value="{{ @$post->link_url }}">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <img src="{{ asset($post->image_url) }}" alt="" width="300">
                            <br>
                            <br>
                        </div>                    
                        <div class="image-editor">
                            ...
                            <span style="color: blue; font-size: 12px">*@lang('main.image_detail')</span> <br>
