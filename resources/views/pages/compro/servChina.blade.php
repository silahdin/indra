...
<?php
$imgBanner = asset('assets/compro/assets/frontend_assets/images/banner/10. China business desk.jpg');
?>
	<div class="space-top">
	</div>
	...
	<section class="about flex-box"
		...
		<div class="boxes">
        <h1>@lang('main.servechina_title')</h1>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="nav-services flex-box">
						...
						<a href="{{ route('compro.servChina') }}" class="active">@lang('main.serveaccount_link9')</a>
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-12">
							<p>@lang('main.servechina_detail1')</p>
							<p>@lang('main.servechina_detail2')</p>
						</div>
					</div>
				</div>
			</div>
