                ...
                <form action="{{ route('module.store') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" value="{{ old('name') }}" placeholder="Module Name"required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control{{ $errors->has('scored') ? ' is-invalid' : '' }}" name="scored" id="scored" style="width: 100%;" required>
                            ...
                            <option value=1 {{ (old('scored') == 1) ? 'selected' : '' }}>Automated</option>
                            <option value=2 {{ (old('scored') == 2) ? 'selected' : '' }}>Automated with Marking</option>
                            <option value=3 {{ (old('scored') == 3) ? 'selected' : '' }}>Not Scored</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control{{ $errors->has('minutes') ? ' is-invalid' : '' }}" name="minutes" id="minutes" value="{{ old('minutes') }}" placeholder="Estimated Time">
