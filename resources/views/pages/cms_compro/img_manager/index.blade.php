          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <td>{{ $no++ }}</td>
                        <td><img src="{{ asset($post->logo) }}" alt="" width="90"></td>
                        <!-- <td>{{ $post->url }}</td> -->
                        ...
                        <td>
                            <a href="{{ route('partner.edit', ['id' => $post->id]) }}">
                                <i class="fa fa-edit text-blue" style="font-size: 20px"></i>
                            </a>&nbsp;
                            <a href="{{ route('partner.delete', ['id' => $post->id]) }}" onclick="return confirm('Apakah anda yakin akan menghapus {{ $post->id }}?')">
