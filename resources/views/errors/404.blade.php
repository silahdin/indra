<?php
	...
	$title = new \stdClass();
	$title->title_in = '404 Not Found';
	$title->title_en = '404 Not Found';
				...
				<div class="col-md-12 col-sm-12">
					<div class="not_found_msg">
						<div class="error_msg_div">
							<h3>Oops, <span>Content can not be Found</span></h3>
							<p>The content you are looking for was not found in our web.<br> Sorry for the inconvenience. </p>
