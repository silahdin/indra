...
<head>
    ...
    <?php }else { ?>
    @if ( Session::get('langIN') != NULL )
    <title>{{ $setting->title_in }}</title>
    @elseif ( Session::get('langEN') != NULL || Session::get('langIN') == NULL )
    <title>{{ $setting->title_en }}</title>
    @endif
    <?php } ?>
    ...
    <meta property="og:site_name" content="{{ (Session::get('langIN') != NULL) ? $setting->site_name_in : $setting->site_name_en }}" />
    <meta property="og:title" content="{{ (Session::get('langIN') != NULL) ? $setting->meta_title_in : $setting->meta_title_en }}" />
    <meta property="og:description" content="{{ (Session::get('langIN') != NULL) ? $setting->meta_description_in : $setting->meta_description_en }}" />
    <meta property="og:keyword" content="{{ (Session::get('langIN') != NULL) ? $setting->meta_keyword_in : $setting->meta_keyword_en }}" />
...
<body>
			...
			<ul>
				...
				<li class="m-parents-service">
					...
					<ul class="">
								...
								@foreach ($servs as $serv)
									<li style="pointer-events: {{ $serv->slug ? 'auto' : 'none' }};"><a href="{{ route('compro.servListId',['id'=>$serv->slug]) }}">{{ ( Session::get('language') == 'ch' ? $serv->name_ch : $serv->name ) }}</a></li>
								@endforeach
				...
				<li class="m-parents-careers">
					<a href="javascript:void(0);">Career</a>
					<ul class="">
						<li><a href="{{ route('compro.career') }}">Recruitment</a></li>
						<li><a href="{{ route('compro.career.meet') }}">Meet Our People</a></li>
						<li><a href="{{ route('compro.career.faq') }}">Frequently Asked Questions</a></li>
					</ul>
					<span class="arrow arrow-top-careers fa fa-chevron-down"></span>
				</li>
				<li>
				...
				<div class="container">
					<div class="bottom-menus">
						<div class="flex-box">
							<ul class="root-menu">
								<li>
									<a href="javascript:void(0);">@lang('main.menu_about')</a>
									<ul class="submenu">
										<li><a href="{{ route('compro.reandaInternational') }}">@lang('main.menu_about_1')</a> </li>
										<li><a href="{{ route('compro.charimanmessage') }}#profileLeader">@lang('main.menu_about_2')</a> </li>
										<li><a href="{{ route('compro.AboutUs') }}">@lang('main.menu_about_3')</a></li>
							...
							<ul class="root-menu">
								<li>
									...
									@foreach ($servs as $serv)
										<li style="pointer-events: {{ $serv->slug ? 'auto' : 'none' }};"><a href="{{ route('compro.servListId',['id'=>$serv->slug]) }}">{{ ( Session::get('language') == 'ch' ? $serv->name_ch : $serv->name ) }}</a></li>
									@endforeach
	                {{-- <li><a href="{{ route('compro.servListId', 'audit-insurance') }}">@lang('main.menu_service_list1')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'tax') }}">@lang('main.menu_service_list2')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'accounting-advisory-services') }}">@lang('main.menu_service_list3')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'china-business-desk') }}">@lang('main.menu_service_list4')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'japan-business-desk') }}">@lang('main.menu_service_list5')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'business-advisory') }}">@lang('main.menu_service_list6')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'entrepreneurial-services') }}">@lang('main.menu_service_list7')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'corporate-finance-services') }}">@lang('main.menu_service_list8')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'merger-acquisition-deals') }}">@lang('main.menu_service_list9')</a></li> --}}
	                {{-- <li><a href="{{ route('compro.servListId', 'technology-consulting') }}">@lang('main.menu_service_list10')</a></li> --}}
							...
							<ul class="root-menu">
								<li>
									<a href="javascript:void(0);">@lang('main.menu_industry')</a>
									<ul class="submenu">
										<li><a href="{{ route('compro.indusCons') }}">@lang('main.menu_industry_1')</a></li>
										<li><a href="{{ route('compro.indusEnergy') }}">@lang('main.menu_industry_2')</a></li>
										<li><a href="{{ route('compro.indusFinan') }}">@lang('main.menu_industry_3')</a> </li>
							...
							<ul class="root-menu">
								<li>
									<a href="javascript:void(0);">@lang('main.menu_newsroom')</a>
									<ul class="submenu">
										<li><a href="{{ route('compro.mediaCenter') }}">@lang('main.menu_newsroom_1') </a></li>
    ...
    @yield('content')
    <p class="enclose problem" style="width: auto !important; right: 0px;">
	...
	<script type="text/javascript">
      ...
      $(".sel-lang").val("{{ session('language') }}");
			...
			$('.arrow-top-careers').click(function(){
				if ( $('li.m-parents-careers').children('ul').hasClass("showed") ) {
					$('li.m-parents-careers').children('ul').removeClass('showed');
				}else{
					$('li.m-parents-careers').children('ul').addClass('showed');
				}
				if ( $('.arrow-top-careers').hasClass("turned") ) {
					$('.arrow-top-careers').removeClass('turned');
				}else{
					$('.arrow-top-careers').addClass('turned');
				}
			})
