...
?>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('pubDB.update', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
        ...
        $('form').submit(function() {
          ...
          return true;
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('title_in') ? ' is-invalid' : '' }}" name="title_in" id="title_in" placeholder="Title Indonesia" value="{{ $post->title_in }}" required>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="location.href='{{ route('pubDB') }}'">@lang('main.cancel')</button>
                  </div>
                </form>
              </div>
